...
function materialize_template_widgets_init()
{
    if (function_exists('register_nav_menus')) {
        register_nav_menus(
            array(
                'main' => __( 'Main menu', 'blog-recetas' ),
                'footer' => __( 'Footer menu', 'blog-recetas' ),
                'profile_1' => __( 'First zone of profile menu', 'blog-recetas' ),
                'profile_2' => __( 'Second zone of profile menu', 'blog-recetas' ),
                'actions_mobile' => __( 'Action buttons zone of mobile menu', 'blog-recetas' ),
            )
        );
    }
    ...
    if (function_exists('register_sidebar')) {
        register_sidebar( array(
            'name'          => __( 'Footer sidebar 1', 'blog-recetas' ),
            'id'            => 'footer-widgets-1',
            'description'   => __( 'First widgets area of the footer', 'blog-recetas' ),
            'before_widget' => '',
            'after_widget'  => '',
        ...
        register_sidebar( array(
            'name'          => __( 'Footer sidebar 2', 'blog-recetas' ),
            'id'            => 'footer-widgets-2',
            'description'   => __( 'Second widgets area of the footer', 'blog-recetas' ),
            'before_widget' => '',
            'after_widget'  => '',
            'before_title'  => '<h5 class="white-text">',
            'after_title'   => '</h5>',
        ...
        register_sidebar( array(
            'name'          => __( 'Footer sidebar 3', 'blog-recetas' ),
            'id'            => 'footer-widgets-3',
            'description'   => __( 'Third widgets area of the footer', 'blog-recetas' ),
            'before_widget' => '',
            'after_widget'  => '',
            'before_title'  => '<h5 class="white-text">',
            'after_title'   => '</h5>',
        ...
        register_sidebar( array(
            'name'          => __( 'Footer profile', 'blog-recetas' ),
            'id'            => 'footer-profile-widgets',
            'class'         => 'collection',
            'description'   => __( 'Profile area of the footer', 'blog-recetas' ),
        ...
        register_sidebar( array(
            'name'          => __( 'Left sidebar', 'blog-recetas' ),
            'id'            => 'left-sidebar',
            'description'   => __( 'Widgets area for left sidebar', 'blog-recetas' ),
            'before_widget' => '',
            'after_widget'  => '',
        ...
        register_sidebar( array(
            'name'          => __( 'Right sidebar', 'blog-recetas' ),
            'id'            => 'right-sidebar',
            'description'   => __( 'Widgets area for right sidebar', 'blog-recetas' ),
            'before_widget' => '',
            'after_widget'  => '',
            'before_title'  => '<h3 class="white-text">',
            'after_title'   => '</h3>',
...
function materialize_template_theme_support()
{
    ...
    load_theme_textdomain( 'blog-recetas', get_template_directory() . '/languages' );
}
...
function materialize_template_comment($comments)
{
    ...
    foreach($comments as $comment) {
        ...
        $default = array(
            ...
            'login_text' => __('Log in to Reply', 'blog-recetas'),
            'depth'      => 1,
            'before'     => '',
            'after'      => '',
            'max_depth'  => $max_depth
